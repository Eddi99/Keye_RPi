...
class user_app_callback_class(app_callback_class): 
    def __init__(self):
        super().__init__()
        self.target_object = "person"  # Typ des Objektes, bei dessen Erkennung in der Gefahrenzone das Realais abgeschaltet wird (mehrere möglich)
        
        # Festlegen der ROI-Grenzen, befindet sich eine Person in diesem Bereich, wird das Relais abgeschaltet (normalisierte Koordinaten 0-1)
        self.zone_x_min = 0.6  # Linke Grenze der ROI
        self.zone_x_max = 1.0  # Rechte Grenze der ROI
        self.zone_y_min = 0.0  # Obere Grenze der ROI
        self.zone_y_max = 1.0  # Untere Grenze der ROI
